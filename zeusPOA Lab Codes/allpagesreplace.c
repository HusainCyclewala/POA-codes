...
void fifo(int incomingStream[], int pages, int frames)
{
    ...
    // s: A variable to track whether a page is present in the frames.
    // temp[]: An array representing the frames in memory, initialized with -1 indicating empty frames.
